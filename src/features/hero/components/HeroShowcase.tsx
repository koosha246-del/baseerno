...
export function HeroShowcase() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="glass flex items-center gap-2.5 rounded-2xl border border-white/60 px-3.5 py-2.5 shadow-lg dark:border-white/10">
      ...
      <motion.div
        ...
        className="overflow-hidden rounded-3xl border border-app-border-subtle bg-surface shadow-2xl"
      >
        {/* Window chrome */}
