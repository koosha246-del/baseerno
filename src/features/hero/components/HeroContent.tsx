  ...
  return (
    ...
    >
      ...
      <motion.div variants={staggerItem}>
        <span className="inline-flex items-center gap-2 rounded-full border border-accent/20 bg-accent-soft px-4 py-2 text-sm font-bold text-accent">
          {badge}
        </span>
      </motion.div>
      ...
      <motion.h1
        ...
        className="font-display text-4xl font-extrabold leading-[1.15] tracking-tight text-fg-primary sm:text-5xl lg:text-[3.75rem] lg:leading-[1.1]"
      >
        {titleLead}{" "}
      ...
      <motion.dl
        variants={staggerItem}
        className="mt-2 grid w-full max-w-lg grid-cols-3 gap-4 border-t border-app-border-subtle pt-6"
      >
        {stats.map((stat) => (
