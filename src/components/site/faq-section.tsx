...
const faqs = [
  {
    ...
    a: "دوره‌های آموزشگاه زبان بصیر برای دو گروه اصلی طراحی شده‌اند: کودکان و نوجوانان. برای هر زبان‌آموز، نقطه‌ی شروع با تعیین سطح مشخص می‌شود تا مسیر آموزشی متناسب با سن و سطح زبان او تنظیم شود.",
  },
  {
